...
namespace LakesideLoungeAndroid.Domain
{
    public class OrderItemComponent
    {
        ...
        public OrderItemComponent(int id, int variationId, string name, string displayName, int orderItemId, int componentId, decimal cost, decimal price, int portions, bool isDefault, int position)
        {
            this.id = id;
